...
CREATE UNIQUE INDEX idx_shadowing_video_segments_video_position ON shadowing_video_segments(video_id, position);
CREATE INDEX idx_shadowing_video_entries_video ON shadowing_video_entries(video_id, updated_at DESC);

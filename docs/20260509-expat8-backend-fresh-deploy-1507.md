...
**Date:** 2026-05-09
**Tag:** `20260509.1507`
**Image:** `docker.x51.vn/x-ai/expat8-backend:20260509.1507`
**Server:** `10.113.213.9`
...
| Smoke test | Passed | `GET http://10.113.213.9:18787/health` returned `{"ok":true}` |
| Android release APK | Passed | Built `mobile/build/app/outputs/flutter-apk/app-release.apk` with backend URL `http://10.113.213.9:18787` |
...
```text
docker inspect expat8-backend -> docker.x51.vn/x-ai/expat8-backend:20260509.1507 running healthy
curl -fsS http://10.113.213.9:18787/health -> {"ok":true}

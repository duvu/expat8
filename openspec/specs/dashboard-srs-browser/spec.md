# dashboard-srs-browser Specification

## Purpose
Define the SRS browser page of the admin dashboard, enabling operators to inspect per-user word states, monitor overdue review counts, and visualize the distribution of SRS statuses across all learners.

# backend-dev-tooling Specification

## Purpose
Ensures the backend has automated linting and formatting tooling (ESLint and Prettier) configured and integrated via npm scripts, so that code style consistency is enforceable in CI and local development.

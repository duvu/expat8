# admin-api-documentation Specification

## Purpose
Ensures that all admin API endpoints actively used by the dashboard or other clients are documented in `contracts/api.md`, including request/response shapes, error codes, and authentication requirements.

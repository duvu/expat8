# dashboard-content-coverage Specification

## Purpose
Define the content coverage page of the admin dashboard, giving operators visibility into vocabulary topic distribution, entry type breakdown, quality score trends, and review throughput.

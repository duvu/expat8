# dashboard-exam-analytics Specification

## Purpose
Define the exam analytics page of the admin dashboard, providing operators with exam pass rate visualization, score distribution, per-topic and per-language breakdowns, and identification of most-missed vocabulary words.

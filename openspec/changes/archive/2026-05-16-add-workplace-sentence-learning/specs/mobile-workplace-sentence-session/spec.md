...
The mobile app SHALL expose a separate study section for common workplace English sentences and SHALL NOT mix workplace sentence cards into the existing vocabulary learning session.

#### Scenario: Learner opens workplace sentence study
- **WHEN** the learner enters the workplace sentence study section
...
The mobile app SHALL import a bundled starter pack of 100 curated workplace English sentence cards into local storage before the first sentence study session requires network access.

#### Scenario: First use while offline
- **WHEN** the learner opens the workplace sentence section on a fresh install while offline
...
- **WHEN** the learner reopens the workplace sentence section after the starter pack was previously imported
...
The mobile app SHALL serve visible workplace sentence cards from local storage and SHALL trigger remote refill only in the background when local sentence inventory falls below a configured threshold.
